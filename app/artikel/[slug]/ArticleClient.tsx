...
export default function ArticleClient({
  ...
  useEffect(() => {
    ...
    // 1. If initialArticle is already present, update rubrik meta and views
    if (article) {
    ...
    // 2. Client-side live fetch for freshness or initial load fallback
    ...
    fetch(`/api/articles/${encodeURIComponent(decodedSlug)}`)
      ...
      .catch((e) => console.warn('Fetch live article failed:', e))
