...
export default function ArticleViewCore({
  ...
  const handleShareInstagram = useCallback(() => {
    ...
    // If Web Share API is available (especially on mobile), open native share sheet for Instagram
    if (typeof navigator !== 'undefined' && navigator.share) {
      ...
      // Desktop fallback: copy link and open Instagram
      if (typeof navigator !== 'undefined' && navigator.clipboard) {
        navigator.clipboard.writeText(url);
      }
      window.open('https://www.instagram.com/', '_blank', 'noopener,noreferrer');
        ...
        >
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center text-white rounded hover:opacity-90 transition-opacity cursor-pointer shadow-sm"
              style={{
